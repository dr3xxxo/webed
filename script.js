document.addEventListener('DOMContentLoaded', () => {
    ...
    const i18n = {
        fr: {
            ...
            rust_tuto_step5: "Choisissez un serveur dans la liste (ne pas prendre un serveur qui colorer) → cliquez sur Copy IP",
            rust_tuto_step6: "Cliquez sur Play, laissez RV There Yet? dans Launch parameters, puis cliquez sur Launch",
        ...
        en: {
            ...
            rust_tuto_step6: "Click Play, leave RV There Yet? in Launch parameters, then click Launch",
